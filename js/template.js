...
jQuery(window).scroll(function() {
    jQuery(document).scrollTop() > 30 && jQuery("#main-header").addClass("sticky").find('#logo_img').removeClass('ht100').addClass('ht80');
    jQuery(document).scrollTop() < 30 && jQuery("#main-header").removeClass("sticky").find('#logo_img').removeClass('ht80').addClass('ht100');
    chosen_drop_down();
});
